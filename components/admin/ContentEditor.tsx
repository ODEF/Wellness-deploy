...
export default function ContentEditor() {
  ...
  function renderActionButtons(label: string) {
    return (
  ...
  function renderSelectedSection() {
    if (status === "Loading") {
      return <div className={styles.loadingBox}>Loading content...</div>;
    }
    ...
    if (selectedSection === "Features") {
      return (
        <>
            ...
            {featuresDraft.items.map((item, index) => (
              <div className={styles.itemEditor} key={index}>
                ...
                <label className={styles.field}>
                  <span>
                    {item.imageUrl ? (
                      <img
                        src={item.imageUrl}
                        alt=""
                        className={styles.previewFeatureImage}
                      />
                    ) : (
                      item.icon
                    )}
                  ...
                  <input
                    value={item.imageUrl ?? ""}
                    placeholder="Enter image URL if you want to use an image instead of an icon"
                    onChange={(event) =>
                ...
                <label className={styles.field}>
                  ...
                  <textarea
                    ...
                    onChange={(event) =>
                      updateFeatureItem(index, "description", event.target.value)
                    }
                  />
                </label>
              </div>
          ...
          {renderActionButtons("Save Features")}
        </>
      );
    }
    ...
    if (selectedSection === "Services") {
      return (
        <>
          ...
          {renderActionButtons("Save Services")}
        </>
      );
    }
    ...
    if (selectedSection === "Grooming") {
      return (
        <>
          ...
          {renderActionButtons("Save Grooming")}
        </>
      );
    }
    ...
    if (selectedSection === "Packages") {
      return (
        <>
          ...
          {renderActionButtons("Save Packages")}
        </>
      );
    }
    ...
    if (selectedSection === "Other Services") {
      return (
        <>
          ...
          {renderActionButtons("Save Other Services")}
        </>
      );
    }
    ...
    if (selectedSection === "Testimonials") {
      return (
        <>
          ...
          {renderActionButtons("Save Testimonials")}
        </>
      );
    }
    ...
    if (selectedSection === "Final CTA") {
      return (
        <>
          ...
          {renderActionButtons("Save Final CTA")}
        </>
      );
    }
    ...
    return (
      <div className={styles.emptyState}>
        ...
        <p>Editable fields for this section can be added later.</p>
      </div>
    );
  }
  ...
  return (
    <AdminLayout
      ...
      actions={
        <>
          <Link href="/" className={shellStyles.secondaryButton}>
            Preview Website
          </Link>
      ...
      <section className={styles.editorGrid}>
        ...
        <aside className={styles.previewPanel}>
          ...
          <p className={styles.previewNote}>
            The preview reloads after saving, so it shows the real saved
            homepage.
          </p>
        </aside>
      </section>
